...
function Introduction() {
    return (
        <section className='bg-[#f6f6f6] py-10 pb-16'>
            <div className='mx-auto w-full max-w-screen-xl px-[4.5rem] flex flex-col space-y-8 sm:space-y-0 sm:flex-row'>
                <div className='flex flex-col items-center justify-center space-y-5'>
                    ...
                    <div className='!mt-10 sm:!mt-14 border-2 border-[#848484] px-4 py-1 rounded hover:bg-[#848484] transform transition-all duration-200 group cursor-pointer'>
